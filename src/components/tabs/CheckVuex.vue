<template>
  ...
  <div class="header">
    <div class="full-name">
      <span class="first-name">{{this.$store.state.payload.name}}</span> 
      
    </div>
    <div class="contact-info">
      <span class="email">Email: </span>
      <span class="email-val">{{this.$store.state.payload.email}}</span>
      <span class="separator"></span>
      <span class="phone">Phone: </span>
      <span class="phone-val">{{this.$store.state.payload.phoneNumber}}</span>
    </div>
